var g_dictReplace = {
	...
	'3flo ([1-3])b>([0-9])s':'éxécution au 3flo: $1 boules tenues plus de $2 secondes',
	'3flo ([1-3])b<([0-9])s':'éxécution au 3flo: $1 boules tenues moins de $2 secondes',
	...
	'Execution': 'Exécution',
	'execution': 'exécution',
	'/EDS1000': 'équilibre statique précaire, marche avant possible mais marches latérale, arrière et changements de direction impossibles',
	'/EDS1100': 'équilibre statique précaire, marches avant et latérale possibles mais marches arrière et changements de direction non sécurisés',
	'/EDS1110': 'équilibre statique correct, marches avant, latérale et arrière possibles mais changements de direction instables',
	'/EDS1111': 'équilibre statique stable, marches avant, latérale, arrière et changements de direction sécurisés',
