var g_dictReplace = {
	...
	'MRC/([0-9]{1,2})/([0-9]{1,2})/([0-9]{1,2})/([0-9]{1,2})/([0-9]{1,2})/([0-9]{1,2})/([0-9]{1,2})': 'score sur l\'échelle .MRC (Medical Research Council): \n\n- Membre supérieur droit: $1/15\n- Membre inférieur droit: $2/15\n==> Total côté droit à $3/30\n\n- Membre supérieur gauche: $4/15 \n- Membre inférieur gauche: $5/15\n==> Total côté gauche à $6/60\n\nScore MRC total à $7/30\n',
	...
	'/MRC':'score sur l\'échelle .MRC (Medical Research Council)',
