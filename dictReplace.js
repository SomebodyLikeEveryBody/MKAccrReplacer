var g_dictReplace = {
	...
	'SPO([0-9]+)AA': 'SpO2 moyenne à $1% en air ambiant',
        'SPO([0-9]+)CN([0-9]+)': 'SpO2 moyenne à $1% sous canules nasales à $2 L d\'O2 / min',
	'SPO([0-9]+)MMC([0-9]+)': 'SpO2 moyenne à $1% sous masque à moyenne concentration à $2 L d\'O2 / min',
	'SPO([0-9]+)MHC([0-9]+)': 'SpO2 moyenne à $1% sous masque à haute concentration à $2 L d\'O2 / min',
	'SPO([0-9]+)SN([0-9]+)': 'SpO2 moyenne à $1% sous sonde nasale d\'O2 à $2 L d\'O2 / min',
